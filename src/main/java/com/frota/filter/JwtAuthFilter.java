...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            // MODO DE DESENVOLVIMENTO: Finge que o usuário "ADMIN" está sempre logado
            req.setAttribute("usuarioLogado", "admin@agrirent.com");
            req.setAttribute("usuarioNome", "Administrador");
            req.setAttribute("usuarioRole", "ADMIN");
            req.setAttribute("usuarioId", 1L);
        }
